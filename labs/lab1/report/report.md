...
![Внесение нескольких изменений в содержимое репозитория](image/img4.png){#fig:004 width=70%}
...
![Просмотр истории](image/img5.png){#fig:005 width=70%}
...
![Удаление коммиттов из ветки](image/img12.png){#fig:012 width=70%}
...
![Изменение предыдущего коммита](image/img14.png){#fig:014 width=70%}
...
![Поиск оригинального файла hello.html](image/img20.png){#fig:020 width=70%}
...
![Создание ветки](image/img21.png){#fig:021 width=70%}

## Навигация по веткам

Посмотрим все логи(рис. @fig:022).

![Просмотр логов новой ветки](image/img22.png){#fig:022 width=70%}
